...
public class UsuarioController {
	...
	public ResponseEntity<Optional<Usuario>> buscarNomeUsuario(@PathVariable String nomeUsuario) {
	...
	@PostMapping("/logar")
	public ResponseEntity<UsuarioLogin> Autenticantion(@RequestBody Optional<UsuarioLogin> user) {
